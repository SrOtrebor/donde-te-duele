...
function dtd_episodio_metabox_html( $post ) {
    ...
    for ( $i = 0; $i <= 4; $i++ ) {
        ...
        echo "<p style='font-size:12px; margin-top:0; margin-bottom:5px;'>Pega los enlaces de Vimeo. <strong>Si aún no hay video, puedes escribir aquí el texto de disponibilidad (Ej: 'Disponible el jueves 14 de Agosto')</strong>.</p>";
